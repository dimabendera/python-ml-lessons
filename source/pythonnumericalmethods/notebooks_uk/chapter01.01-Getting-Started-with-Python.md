...
<p><img alt="Завантаження Miniconda" src="../_images/01.01.1-miniconda_page.png"/></p>
...
<p><img alt="Запуск інсталятора" src="../_images/01.01.2-run_miniconda_installer.png"/></p>
...
<p><img alt="Розташування за замовчуванням" src="../_images/01.01.3-default_miniconda_location.png"/></p>
<p>Після встановлення ви можете перевірити встановлені пакети, ввівши наступні команди:</p>
<p><img alt="Швидка перевірка" src="../_images/01.01.4-miniconda_check.png"/></p>
...
<p><img alt="Встановлення пакетів" src="../_images/01.01.5-install_packages.png"/></p>
...
<p><img alt="Привіт, світ" src="../_images/01.01.6-ipython_example.png"/></p>
...
<p><img alt="Файл Python" src="../_images/01.01.7-python_file_example.png"/></p>
<p>Потім просто запустіть його з термінала:</p>
<p><img alt="Запуск Python" src="../_images/01.01.8-run_python_file.png"/></p>
...
<p><img alt="Запуск Jupyter" src="../_images/01.01.9-launching_jupyter.png"/></p>
...
<p><img alt="Приклад блокнота" src="../_images/01.01.10-run_code_jupyter.png"/></p>
<h2>Дзен Пайтона</h2>
